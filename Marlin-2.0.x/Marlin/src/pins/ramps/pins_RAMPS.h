...
//
	...
	// @yaasiin : dans notre cas nous aurons besoin que des endstop X_MIN ET Y_MIN, ces endstop seront 
	// branchés uniquement sur les pins interrupts 2 et 3
#ifndef X_STOP_PIN
  #ifndef X_MIN_PIN
    #define X_MIN_PIN                          2			// @yaasiin : ancienne valeur 3
  #endif
  #ifndef X_MAX_PIN
    #define X_MAX_PIN                          14			// @yaasiin : ancienne valeur 2	
  #endif
#endif
#ifndef Y_STOP_PIN
  #ifndef Y_MIN_PIN
    #define Y_MIN_PIN                         3			// @yaasiin : ancienne valeur 14
  #endif
  #ifndef Y_MAX_PIN
    #define Y_MAX_PIN                         15			// @yaasiin : ancienne valeur 15
  #endif
#endif
#ifndef Z_STOP_PIN
  #ifndef Z_MIN_PIN
    #define Z_MIN_PIN                         18			// @yaasiin : ancienne valeur 18				
  #endif
  #ifndef Z_MAX_PIN
    #define Z_MAX_PIN                         19
  #endif
...
#endif
#ifndef RAMPS_D8_PIN
  #define RAMPS_D8_PIN                         44			// @yaasiin : configuration du FAN_PIN (old val = 8) 
#endif									                              // @yaasiin : cf MPCNC-laser-add-on-walk-through.pdf page 6
#ifndef RAMPS_D9_PIN
